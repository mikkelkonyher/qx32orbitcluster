...
const YES_NO_STARTERS = {
  english: ['is', 'are', 'do', 'does', 'can', 'will', 'should', 'did', 'has', 'have', 'was', 'were', 'would', 'could'],
  danish: ['er', 'kan', 'vil', 'gør', 'har', 'var', 'ville', 'kunne', 'må', 'bør', 'skal', 'skulle'],
  spanish: ['es', 'son', 'hace', 'puede', 'debe', 'hará', 'está', 'están', 'hizo', 'hizo', 'será', 'pueden', 'deben', 'tiene', 'tienen']
};
...
export const isValidYesNoQuestion = (input: string): boolean => {
  ...
  if ((firstWord === 'is' || firstWord === 'are' || firstWord === 'was' || firstWord === 'were') && 
